...
export default function NewSpaceModal({ users, onCancel, onCreate }: Props) {
  ...
  return (
    <div className="modal-backdrop" onClick={onCancel}>
      <form className="modal" onClick={(e) => e.stopPropagation()} onSubmit={handleSubmit}>
        ...
        <label>
          스페이스 이름
          <input value={name} onChange={(e) => setName(e.target.value)} placeholder="예: 개발팀" autoFocus />
        </label>
